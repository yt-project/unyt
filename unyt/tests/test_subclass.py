...
class TestNumpyFunctions:
    ...
    def test_explicitly_handled_funcs(self):
        ...
        functions_to_check = {
            ...
            "array2string": (sub_arr(np.arange(3.0)),),
            "dot": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "vdot": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "inner": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "outer": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "kron": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "histogram_bin_edges": (sub_arr(np.arange(3.0)),),
            ...
            "histogram": (sub_arr(np.arange(3.0)),),
            "histogram2d": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            "histogramdd": (sub_arr(np.arange(3.0)).reshape((1, 3)),),
            "concatenate": (sub_arr(np.eye(3)),),
            "cross": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "intersect1d": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            "union1d": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "linalg.norm": (sub_arr(np.arange(3.0)),),
            "vstack": (sub_arr(np.arange(3.0)),),
            "hstack": (sub_arr(np.arange(3.0)),),
            "dstack": (sub_arr(np.arange(3.0)),),
            "column_stack": (sub_arr(np.arange(3.0)),),
            "stack": (sub_arr(np.arange(3.0)),),
            "around": (sub_arr(np.arange(3.0)),),
            "block": ([[sub_arr(np.arange(3.0))], [sub_arr(np.arange(3.0))]],),
            "fft.fft": (sub_arr(np.arange(3.0)),),
            "fft.fft2": (sub_arr(np.eye(3)),),
            "fft.fftn": (sub_arr(np.arange(3.0)),),
            "fft.hfft": (sub_arr(np.arange(3.0)),),
            "fft.rfft": (sub_arr(np.arange(3.0)),),
            "fft.rfft2": (sub_arr(np.eye(3)),),
            "fft.rfftn": (sub_arr(np.arange(3.0)),),
            "fft.ifft": (sub_arr(np.arange(3.0)),),
            "fft.ifft2": (sub_arr(np.eye(3)),),
            "fft.ifftn": (sub_arr(np.arange(3.0)),),
            "fft.ihfft": (sub_arr(np.arange(3.0)),),
            "fft.irfft": (sub_arr(np.arange(3.0)),),
            "fft.irfft2": (sub_arr(np.eye(3)),),
            "fft.irfftn": (sub_arr(np.arange(3.0)),),
            "fft.fftshift": (sub_arr(np.arange(3.0)),),
            "fft.ifftshift": (sub_arr(np.arange(3.0)),),
            "sort_complex": (sub_arr(np.arange(3.0)),),
            "isclose": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "allclose": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "array_equal": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            ...
            "copyto": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "prod": (sub_arr(np.arange(3.0)),),
            "var": (sub_arr(np.arange(3.0)),),
            "trace": (sub_arr(np.eye(3)),),
            "percentile": (sub_arr(np.arange(3.0)), 30),
            "quantile": (sub_arr(np.arange(3.0)), 0.3),
            "nanpercentile": (sub_arr(np.arange(3.0)), 30),
            "nanquantile": (sub_arr(np.arange(3.0)), 0.3),
            "linalg.det": (sub_arr(np.eye(3)),),
            "diff": (sub_arr(np.arange(3.0)),),
            "ediff1d": (sub_arr(np.arange(3.0)),),
            "ptp": (sub_arr(np.arange(3.0)),),
            "cumprod": (sub_arr(np.arange(3.0)),),
            "pad": (sub_arr(np.arange(3.0)), 3),
            "choose": (np.arange(3), sub_arr(np.eye(3))),
            "insert": (sub_arr(np.arange(3.0)), 1, sub_q(1)),
            ...
            "savetxt": (savetxt_file, sub_arr(np.arange(3.0))),
            "fill_diagonal": (
                sub_arr(np.eye(3)),
                sub_arr(np.arange(3.0)),
            ),
            "apply_over_axes": (lambda x, axis: x, sub_arr(np.eye(3)), (0, 1)),
            "isin": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "place": (
                sub_arr(np.arange(3.0)),
                np.arange(3.0) > 0,
                sub_arr(np.arange(3.0)),
            ...
            "select": (
                ...
                [sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))],
                sub_q(1),
            ),
            "setdiff1d": (
                sub_arr(np.arange(3.0)),
            ...
            "sinc": (sub_arr(np.arange(3.0)),),
            "clip": (sub_arr(np.arange(3.0)), sub_q(1), sub_q(2)),
            "where": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ...
            "convolve": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "correlate": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "unwrap": (sub_arr(np.arange(3.0)),),
            "interp": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            "array_repr": (sub_arr(np.arange(3.0)),),
            trapezoid_fname: (sub_arr(np.arange(3.0)),),
            "take": (sub_arr(np.arange(3)), np.arange(3)),
            # FUNCTIONS THAT UNYT DOESN'T HANDLE EXPLICITLY (THEY "JUST WORK"):
            "all": (sub_arr(np.arange(3.0)),),
            "amax": (sub_arr(np.arange(3.0)),),  # implemented via max
            "amin": (sub_arr(np.arange(3.0)),),  # implemented via min
            "angle": (sub_q(complex(1, 1)),),
            "any": (sub_arr(np.arange(3.0)),),
            "append": (sub_arr(np.arange(3.0)), sub_q(1)),
            "apply_along_axis": (lambda x: x, 0, sub_arr(np.eye(3))),
            "argmax": (sub_arr(np.arange(3.0)),),  # implemented via max
            "argmin": (sub_arr(np.arange(3.0)),),  # implemented via min
            "argpartition": (
                sub_arr(np.arange(3.0)),
                1,
            ),  # implemented via partition
            "argsort": (sub_arr(np.arange(3.0)),),  # implemented via sort
            "argwhere": (sub_arr(np.arange(3.0)),),
            "array_str": (sub_arr(np.arange(3.0)),),
            "atleast_1d": (sub_arr(np.arange(3.0)),),
            "atleast_2d": (sub_arr(np.arange(3.0)),),
            "atleast_3d": (sub_arr(np.arange(3.0)),),
            "average": (sub_arr(np.arange(3.0)),),
            "can_cast": (sub_arr(np.arange(3.0)), np.float64),
            "common_type": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            "result_type": (sub_arr(np.ones(3)), sub_arr(np.ones(3))),
            "iscomplex": (sub_arr(np.arange(3.0)),),
            "iscomplexobj": (sub_arr(np.arange(3.0)),),
            "isreal": (sub_arr(np.arange(3.0)),),
            "isrealobj": (sub_arr(np.arange(3.0)),),
            "nan_to_num": (sub_arr(np.arange(3.0)),),
            "nanargmax": (sub_arr(np.arange(3.0)),),  # implemented via max
            "nanargmin": (sub_arr(np.arange(3.0)),),  # implemented via min
            "nanmax": (sub_arr(np.arange(3.0)),),  # implemented via max
            "nanmean": (sub_arr(np.arange(3.0)),),  # implemented via mean
            "nanmedian": (sub_arr(np.arange(3.0)),),  # implemented via median
            "nanmin": (sub_arr(np.arange(3.0)),),  # implemented via min
            "trim_zeros": (sub_arr(np.arange(3.0)),),
            "max": (sub_arr(np.arange(3.0)),),
            "mean": (sub_arr(np.arange(3.0)),),
            "median": (sub_arr(np.arange(3.0)),),
            "min": (sub_arr(np.arange(3.0)),),
            "ndim": (sub_arr(np.arange(3.0)),),
            "shape": (sub_arr(np.arange(3.0)),),
            "size": (sub_arr(np.arange(3.0)),),
            "sort": (sub_arr(np.arange(3.0)),),
            "sum": (sub_arr(np.arange(3.0)),),
            "repeat": (sub_arr(np.arange(3.0)), 2),
            "tile": (sub_arr(np.arange(3.0)), 2),
            "shares_memory": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            "nonzero": (sub_arr(np.arange(3.0)),),
            "count_nonzero": (sub_arr(np.arange(3.0)),),
            "flatnonzero": (sub_arr(np.arange(3.0)),),
            "isneginf": (sub_arr(np.arange(3.0)),),
            "isposinf": (sub_arr(np.arange(3.0)),),
            "empty_like": (sub_arr(np.arange(3.0)),),
            "full_like": (sub_arr(np.arange(3.0)), sub_q(1)),
            "ones_like": (sub_arr(np.arange(3.0)),),
            "zeros_like": (sub_arr(np.arange(3.0)),),
            "copy": (sub_arr(np.arange(3.0)),),
            "meshgrid": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "transpose": (sub_arr(np.eye(3)),),
            "reshape": (sub_arr(np.arange(3.0)), (3,)),
            "resize": (sub_arr(np.arange(3.0)), 6),
            "roll": (sub_arr(np.arange(3.0)), 1),
            "rollaxis": (sub_arr(np.arange(3.0)), 0),
            "rot90": (sub_arr(np.eye(3)),),
            "expand_dims": (sub_arr(np.arange(3.0)), 0),
            "squeeze": (sub_arr(np.arange(3.0)),),
            "flip": (sub_arr(np.eye(3)),),
            "fliplr": (sub_arr(np.eye(3)),),
            "flipud": (sub_arr(np.eye(3)),),
            "delete": (sub_arr(np.arange(3.0)), 0),
            "partition": (sub_arr(np.arange(3.0)), 1),
            "broadcast_to": (sub_arr(np.arange(3.0)), 3),
            "broadcast_arrays": (sub_arr(np.arange(3.0)),),
            "split": (sub_arr(np.arange(3.0)), 1),
            "array_split": (sub_arr(np.arange(3.0)), 1),
            "dsplit": (sub_arr(np.arange(27)).reshape(3, 3, 3), 1),
            "hsplit": (sub_arr(np.arange(3.0)), 1),
            "vsplit": (sub_arr(np.eye(3)), 1),
            "swapaxes": (sub_arr(np.eye(3)), 0, 1),
            "moveaxis": (sub_arr(np.eye(3)), 0, 1),
            "nansum": (sub_arr(np.arange(3.0)),),  # implemented via sum
            "std": (sub_arr(np.arange(3.0)),),
            "nanstd": (sub_arr(np.arange(3.0)),),
            "nanvar": (sub_arr(np.arange(3.0)),),
            "nanprod": (sub_arr(np.arange(3.0)),),
            "diag": (sub_arr(np.eye(3)),),
            "diag_indices_from": (sub_arr(np.eye(3)),),
            "diagflat": (sub_arr(np.eye(3)),),
            "diagonal": (sub_arr(np.eye(3)),),
            "ravel": (sub_arr(np.arange(3.0)),),
            "ravel_multi_index": (np.eye(2, dtype=int), (2, 2)),
            "unravel_index": (np.arange(3), (3,)),
            "fix": (sub_arr(np.arange(3.0)),),
            "round": (sub_arr(np.arange(3.0)),),  # implemented via around
            "may_share_memory": (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            ),
            ...
            "gradient": (sub_arr(np.arange(3.0)),),
            "cumsum": (sub_arr(np.arange(3.0)),),
            "nancumsum": (sub_arr(np.arange(3.0)),),
            "nancumprod": (sub_arr(np.arange(3.0)),),
            "bincount": (sub_arr(np.arange(3)),),
            "unique": (sub_arr(np.arange(3.0)),),
            "min_scalar_type": (sub_arr(np.arange(3.0)),),
            "extract": (0, sub_arr(np.arange(3.0))),
            "setxor1d": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "lexsort": (sub_arr(np.arange(3.0)),),
            "digitize": (sub_arr(np.arange(3.0)), sub_arr(np.arange(3.0))),
            "tril_indices_from": (sub_arr(np.eye(3)),),
            "triu_indices_from": (sub_arr(np.eye(3)),),
            "imag": (sub_arr(np.arange(3.0)),),
            "real": (sub_arr(np.arange(3.0)),),
            "real_if_close": (sub_arr(np.arange(3.0)),),
            "einsum_path": (
                "ij,jk->ik",
                sub_arr(np.eye(3)),
                sub_arr(np.eye(3)),
            ),
            "cov": (sub_arr(np.arange(3.0)),),
            "corrcoef": (sub_arr(np.arange(3.0)),),
            "compress": (np.zeros(3), sub_arr(np.arange(3.0))),
            "take_along_axis": (
                sub_arr(np.arange(3.0)),
                np.ones(3, dtype=int),
                0,
        ...
        if NUMPY_VERSION >= Version("2.0.0dev0"):
            ...
            functions_to_check["linalg.vector_norm"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["astype"] = (sub_arr(np.arange(3.0)), float)
            functions_to_check["matrix_transpose"] = (sub_arr(np.eye(3)),)
            functions_to_check["unique_all"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["unique_counts"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["unique_inverse"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["unique_values"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["cumulative_sum"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["cumulative_prod"] = (sub_arr(np.arange(3.0)),)
            functions_to_check["unstack"] = (sub_arr(np.arange(3.0)),)
        else:
            functions_to_check["asfarray"] = (sub_arr(np.arange(3.0)),)

        if NUMPY_VERSION < Version("2.4.0.dev0"):
            functions_to_check["in1d"] = (
                sub_arr(np.arange(3.0)),
                sub_arr(np.arange(3.0)),
            )
