...
mass_electron_mks = mass_electron = me = unyt_quantity(_mass_electron_kg, "kg")
...
#: Mass of hydrogen
mp = mh = mass_hydrogen = mass_hydrogen_mks = unyt_quantity(_mass_hydrogen_kg, "kg")

# Velocities
#: speed of light
c = clight = speed_of_light = speed_of_light_mks = unyt_quantity(
    _speed_of_light_m_per_s, "m/s"
)
...
) = cross_section_thompson = cross_section_thompson_mks = unyt_quantity(
...
qp = (
    elementary_charge
) = proton_charge = charge_proton = charge_proton_mks = unyt_quantity(
    1.6021766208e-19, "C"
)
#: Charge of the electron
electron_charge = charge_electron = charge_electron_mks = -qp

qp_cgs = elementary_charge_cgs = proton_charge_cgs = charge_proton_cgs = unyt_quantity(
    4.8032056e-10, "esu"
)
...
G = (
    newtons_constant
) = gravitational_constant = gravitational_constant_mks = unyt_quantity(
    _newton_mks, "m**3/kg/s**2"
)

#: Planck constant
hmks = planck_constant = planck_constant_mks = unyt_quantity(_planck_mks, "J*s")
...
# Solar System
#: Mass of the sun
msun = solar_mass = mass_sun = mass_sun_mks = unyt_quantity(_mass_sun_kg, "kg")
...
#: Mass of Mercury
mercury_mass = mass_mercury = mass_mercury_mks = unyt_quantity(_mass_mercury_kg, "kg")

#: Mass of Venus
venus_mass = mass_venus = mass_venus_mks = unyt_quantity(_mass_venus_kg, "kg")
...
#: Mass of Saturn
saturn_mass = mass_saturn = mass_saturn_mks = unyt_quantity(_mass_saturn_kg, "kg")

#: Mass of Uranus
uranus_mass = mass_uranus = mass_uranus_mks = unyt_quantity(_mass_uranus_kg, "kg")

#: Mass of Neptune
neptune_mass = mass_neptune = mass_neptune_mks = unyt_quantity(_mass_neptune_kg, "kg")
