...
formula to Python and then converting the answer to the units we want in the
  ...
  >>> period = 2*pi*(semimajor_axis**3/(G*Mjup))**0.5
  >>> period
  unyt_array([ 152862.07749598,  306823.03283555,  618151.99154184,
         1441928.42371994], 's')
  >>> period.to('d')
  unyt_array([ 1.76923701,  3.55119251,  7.15453694, 16.68898639], 'day')
...
will immediately be able to use it just like the built-in unit systems:
  ...
  unyt_quantity(0.59746601, 'mp*nm**2/fs**3')
